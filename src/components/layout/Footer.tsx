...
export default function Footer() {
  return (
    <footer className="w-full bg-[#050505] text-[var(--text-secondary)] py-16 px-6 lg:px-12 border-t border-[rgba(197,168,128,0.2)]">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-12 pb-12 border-b border-[rgba(255,255,255,0.08)]">
      ...
      <div className="max-w-7xl mx-auto pt-8 flex flex-col sm:flex-row items-center justify-between text-[11px] font-mono text-[var(--text-muted)] gap-4">
